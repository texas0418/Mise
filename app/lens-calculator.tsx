...
const styles = StyleSheet.create({
  ...
  sectionTitle: { fontSize: 12, fontWeight: '700' as const, color: Colors.text.tertiary, textTransform: 'uppercase' as const, letterSpacing: 1.2, marginBottom: 10 },
  ...
  sensorInfo: { fontSize: 12, color: Colors.text.tertiary, marginTop: 8 },
  ...
  aspectName: { fontSize: 12, color: Colors.text.tertiary, marginTop: 1 },
  ...
  lensType: { fontSize: 12, color: Colors.text.tertiary, marginTop: 1 },
  ...
  fovText: { fontSize: 12, color: Colors.text.tertiary, marginTop: 4 },
  lensRight: { alignItems: 'flex-end' },
  equivText: { fontSize: 13, fontWeight: '600' as const, color: Colors.text.secondary },
  equivLabel: { fontSize: 12, color: Colors.text.tertiary },
