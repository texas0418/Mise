...
export default function SelectsScreen() {
  ...
  return (
    ...
    <View style={styles.container}>
          ...
          <View>
            ...
            <View style={styles.filterRow}>
              {([
                ...
                <TouchableOpacity accessibilityRole="button" key={f.key} style={[styles.filterChip, filter === f.key && styles.filterChipActive]}
      ...
      />
      <TouchableOpacity accessibilityRole="button" accessibilityLabel="Add a select" style={styles.fab} onPress={() => router.push('/new-select' as never)} activeOpacity={0.8}>
...
const styles = StyleSheet.create({
  ...
  sceneCount: { fontSize: 12, color: Colors.text.tertiary },
  ...
  circledBadge: { fontSize: 12, fontWeight: '700' as const, color: Colors.accent.gold, backgroundColor: Colors.accent.goldBg, paddingHorizontal: 7, paddingVertical: 2, borderRadius: 8, letterSpacing: 0.5 },
  altBadge: { fontSize: 12, fontWeight: '700' as const, color: '#60A5FA', backgroundColor: '#60A5FA18', paddingHorizontal: 7, paddingVertical: 2, borderRadius: 8, letterSpacing: 0.5 },
  starRow: { flexDirection: 'row', gap: 2, marginBottom: 4 },
  timecodeRow: { flexDirection: 'row', alignItems: 'center', gap: 4, marginBottom: 6 },
  timecodeText: { fontSize: 12, color: Colors.text.tertiary, fontFamily: 'monospace' },
  ...
  noteLabel: { fontSize: 12, fontWeight: '700' as const, letterSpacing: 0.8 },
