...
const styles = StyleSheet.create({
  ...
  refScene: { fontSize: 12, color: '#ddd', marginTop: 2 },
  // Collapsed body
  cardBody: { padding: 10 },
  ...
  tagText: { fontSize: 12, color: Colors.text.secondary, fontWeight: '600' as const, textTransform: 'uppercase' as const, letterSpacing: 0.5 },
  tagMore: { fontSize: 12, color: Colors.text.tertiary, alignSelf: 'center' },
  // Expanded body
