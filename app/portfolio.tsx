...
const styles = StyleSheet.create({
  ...
  sectionTitle: { fontSize: 12, fontWeight: '700' as const, color: Colors.text.tertiary, textTransform: 'uppercase' as const, letterSpacing: 1.2, marginBottom: 12 },
  ...
  formatText: { fontSize: 12, fontWeight: '600' as const, color: Colors.text.secondary, textTransform: 'uppercase' as const },
  ...
  festivalText: { fontSize: 12, fontWeight: '600' as const, color: Colors.accent.gold },
  awardRow: { marginTop: 6 },
  awardText: { fontSize: 12, fontWeight: '600' as const, color: '#F59E0B' },
  creditNotes: { fontSize: 12, color: Colors.text.tertiary, marginTop: 4, fontStyle: 'italic' as const },
